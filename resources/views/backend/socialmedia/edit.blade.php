    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-header pb-0">
                ...
                <p class="mb-0">UPDATE {{strtoupper($socialmedia->socialmedia_name)}}</p>
                </div>
            </div>
            <form action="/admin-socialmedia-update/{{$socialmedia->id}}" method="POST">@csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <code style="font-size:12px">Update hanya berlaku untuk {{strtoupper($socialmedia->socialmedia_name)}} maupun SOCIAL MEDIA yang belum pernah dibuat</code>
                        </div>
                        <div class="col-md-9 row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="socialmedia_source" name="socialmedia_source" type="text" placeholder="input socialmedia source" value="{{ $socialmedia->socialmedia_source }}">
                                    <input class="form-control" id="socialmedia_id" name="socialmedia_id" type="hidden" value="{{ $socialmedia->id }}">
                                </div>
                            </div>
                        </div>
                    </div>

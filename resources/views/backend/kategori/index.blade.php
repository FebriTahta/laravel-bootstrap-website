      ...
      $.each(data, function (index, item) {
        ...
        var row = `<tr>
          ...
          <td class="text-center">
            <a href="/admin-kategori-edit/${item.id}" style="margin-right:5px" class="btn btn-xs btn-info font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
